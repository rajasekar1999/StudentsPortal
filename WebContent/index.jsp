...
<section style=" background-image: url('https://i.ibb.co/sHcBdr4/pencil.jpg'); background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%;" class="page-content">
  <section class="search-and-user">
    ...
    <div class="admin-profile">
      <span class="greeting" style=" background-color: rgba(39, 39, 39, 0); float: right; margin-left: 86%;">Hello <%= request.getParameter("username") %></span>
  ...
  <div class="img-rounded" style="float: right; background-color: #7172724f; width: 315px; height: 560px; border: 1px solid black; margin: 10px;">
   ...
   <h1 style="margin-top: 25%; text-align: center;font-size: 300%;"> WELCOME ADMIN TO YOUR WORKSPACE </h1>
  <section class="grid">

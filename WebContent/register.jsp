...
<script src="http://mysqljs.com/mysql.js">
</script>
</head>
...
<section style=" background-image: url('https://i.ibb.co/sHcBdr4/pencil.jpg'); background-repeat: no-repeat;background-attachment: fixed; background-size: 100% 100%;" class="page-content">
  <section class="search-and-user">
    ...
    <div class="jumbotron jumbotron-fluid" style="margin-left:300px;width:500px;opacity:85%;">
  ...
  <div class="form-group">
    ...
    <input type="text" style="width:300px;" class="form-control" name="username" placeholder="">
  </div>
  <div class="form-group">
    <label>Password</label>
    <input type="password" style="width:300px;" class="form-control" name="password" placeholder="">
  </div>
  <div class="form-group">
    <label>Confirm Password</label>
    <input type="password" style="width:300px;" class="form-control" name="password2" placeholder="">
  </div>
    <input type="submit" style="width:300px;" value="submit" style="padding-left:30px;padding-right:30px;" class="form-control"></input>
  </div>
</center>
</form>
</div>

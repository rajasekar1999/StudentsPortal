...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
   ...
   <center>
   <br><br>
   	<h1> Result of the Query </h1></center>
   	<br>
      <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver"
         url = "jdbc:mysql://localhost:3306/Attendance?useSSL=false"
         user = "root" password = "Raja@1999"/>
         <sql:query dataSource = "${snapshot}" var = "result">
         select * from at_details natural join marks where rollnumber like "cb.en.u4cse1736_" and cgpa> <%= request.getParameter("cgpa1")%>  
         and cgpa< <%= request.getParameter("cgpa2")%> order by <%= request.getParameter("sort") %> desc;
      </sql:query>
